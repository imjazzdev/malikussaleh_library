...
class SearchingMahasiswaPage extends StatefulWidget {
  const SearchingMahasiswaPage({super.key});

  @override
  State<SearchingMahasiswaPage> createState() => _SearchingMahasiswaPageState();
}

class _SearchingMahasiswaPageState extends State<SearchingMahasiswaPage> {
